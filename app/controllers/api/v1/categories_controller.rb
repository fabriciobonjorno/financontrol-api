...
module Api
  module V1
    class CategoriesController < ApiController
      def index
        Api::V1::CategoriesServices::Index::UseCase.call([params, current_user]) do |on|
      ...
      def create
        Api::V1::CategoriesServices::Create::UseCase.call([params, current_user]) do |on|
          on.failure(:validate_params) { |message| render json: { message: }, status: 400 }
      ...
      def update
        Api::V1::CategoriesServices::Update::UseCase.call([params, current_user]) do |on|
          on.failure(:validate_params) { |message| render json: { message: }, status: 400 }
      ...
      def destroy
        Api::V1::CategoriesServices::Delete::UseCase.call([params, current_user]) do |on|
          on.failure(:validate_params) { |message| render json: { message: }, status: 400 }
